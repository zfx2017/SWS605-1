...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'bitbangSetup'
;------------------------------------------------------------
;	bitbang.c:10: void bitbangSetup()
;	-----------------------------------------
;	 function bitbangSetup
;	-----------------------------------------
_bitbangSetup:
	ar7 = 0x07
	ar6 = 0x06
	...
	ar1 = 0x01
	ar0 = 0x00
;	bitbang.c:13: P1_DIR_PU &= 0x0C;
	anl	_P1_DIR_PU,#0x0c
;	bitbang.c:14: P1_MOD_OC = P1_MOD_OC & ~(1<<LED_PIN);
	anl	_P1_MOD_OC,#0xdf
;	bitbang.c:15: P1_DIR_PU = P1_DIR_PU |	(1<<LED_PIN);
	orl	_P1_DIR_PU,#0x20
;	bitbang.c:16: }
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'bitbangWs2812'
;------------------------------------------------------------
;ledData                   Allocated with name '_bitbangWs2812_PARM_2'
;ledCount                  Allocated to registers 
;------------------------------------------------------------
;	bitbang.c:18: void bitbangWs2812( uint8_t ledCount, __xdata uint8_t * ledData )
;	-----------------------------------------
;	 function bitbangWs2812
;	-----------------------------------------
_bitbangWs2812:
;	bitbang.c:123: __endasm;
