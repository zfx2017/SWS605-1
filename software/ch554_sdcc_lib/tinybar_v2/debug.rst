      ...
      000000                        508 	.ds 8
                                    ...
                                    511 ;--------------------------------------------------------
                                    512 	.area DSEG    (DATA)
      000016                        513 _mInitSTDIO_x_1_16:
      000016                        514 	.ds 4
      00001A                        515 _mInitSTDIO_x2_1_16:
      00001A                        516 	.ds 1
                                    517 ;--------------------------------------------------------
      ...
      000AC6 75 A1 55         [24]  598 	mov	_SAFE_MOD,#0x55
                                    599 ;	../include/debug.c:35: SAFE_MOD = 0xAA;
      000AC9 75 A1 AA         [24]  600 	mov	_SAFE_MOD,#0xaa
                                    601 ;	../include/debug.c:42: CLOCK_CFG = CLOCK_CFG & ~ MASK_SYS_CK_SEL | 0x05;  // 16MHz	
      000ACC 74 F8            [12]  602 	mov	a,#0xf8
      000ACE 55 B9            [12]  603 	anl	a,_CLOCK_CFG
      000AD0 44 05            [12]  604 	orl	a,#0x05
      000AD2 F5 B9            [12]  605 	mov	_CLOCK_CFG,a
                                    606 ;	../include/debug.c:57: SAFE_MOD = 0x00;
      000AD4 75 A1 00         [24]  607 	mov	_SAFE_MOD,#0x00
      000AD7 22               [24]  608 	ret
                                    609 ;------------------------------------------------------------
                                    ...
                                    617 ;	-----------------------------------------
      000AD8                        618 _mDelayuS:
      000AD8 AE 82            [24]  619 	mov	r6,dpl
      000ADA AF 83            [24]  620 	mov	r7,dph
                                    621 ;	../include/debug.c:82: while ( n ) {  // total = 12~13 Fsys cycles, 1uS @Fsys=12MHz
      000ADC                        622 00101$:
      000ADC EE               [12]  623 	mov	a,r6
      000ADD 4F               [12]  624 	orl	a,r7
      000ADE 60 0D            [24]  625 	jz	00104$
                                    626 ;	../include/debug.c:83: ++ SAFE_MOD;  // 2 Fsys cycles, for higher Fsys, add operation here
      000AE0 05 A1            [12]  627 	inc	_SAFE_MOD
                                    628 ;	../include/debug.c:86: ++ SAFE_MOD;
      000AE2 05 A1            [12]  629 	inc	_SAFE_MOD
                                    630 ;	../include/debug.c:89: ++ SAFE_MOD;
      000AE4 05 A1            [12]  631 	inc	_SAFE_MOD
                                    632 ;	../include/debug.c:116: -- n;
      000AE6 1E               [12]  633 	dec	r6
      000AE7 BE FF 01         [24]  634 	cjne	r6,#0xff,00114$
      000AEA 1F               [12]  635 	dec	r7
      000AEB                        636 00114$:
      000AEB 80 EF            [24]  637 	sjmp	00101$
      000AED                        638 00104$:
      000AED 22               [24]  639 	ret
                                    640 ;------------------------------------------------------------
                                    ...
                                    648 ;	-----------------------------------------
      000AEE                        649 _mDelaymS:
      000AEE AE 82            [24]  650 	mov	r6,dpl
      000AF0 AF 83            [24]  651 	mov	r7,dph
                                    652 ;	../include/debug.c:129: while ( n ) {
      000AF2                        653 00101$:
      000AF2 EE               [12]  654 	mov	a,r6
      000AF3 4F               [12]  655 	orl	a,r7
      000AF4 60 15            [24]  656 	jz	00104$
                                    657 ;	../include/debug.c:134: mDelayuS( 1000 );
      000AF6 90 03 E8         [24]  658 	mov	dptr,#0x03e8
      000AF9 C0 07            [24]  659 	push	ar7
      000AFB C0 06            [24]  660 	push	ar6
      000AFD 12 0A D8         [24]  661 	lcall	_mDelayuS
      000B00 D0 06            [24]  662 	pop	ar6
      000B02 D0 07            [24]  663 	pop	ar7
                                    664 ;	../include/debug.c:136: -- n;
      000B04 1E               [12]  665 	dec	r6
      000B05 BE FF 01         [24]  666 	cjne	r6,#0xff,00114$
      000B08 1F               [12]  667 	dec	r7
      000B09                        668 00114$:
      000B09 80 E7            [24]  669 	sjmp	00101$
      000B0B                        670 00104$:
      000B0B 22               [24]  671 	ret
                                    672 ;------------------------------------------------------------
                                    ...
                                    678 ;	-----------------------------------------
      000B0C                        679 _CH554UART0Alter:
                                    680 ;	../include/debug.c:149: PIN_FUNC |= bUART0_PIN_X;                                                  //串口映射到P1.2和P1.3
      000B0C 43 C6 10         [24]  681 	orl	_PIN_FUNC,#0x10
      000B0F 22               [24]  682 	ret
                                    683 ;------------------------------------------------------------
                                    ...
                                    692 ;	-----------------------------------------
      000B10                        693 _mInitSTDIO:
                                    694 ;	../include/debug.c:166: SM0 = 0;
      000B10 C2 9F            [12]  695 	clr	_SM0
                                    696 ;	../include/debug.c:167: SM1 = 1;
      000B12 D2 9E            [12]  697 	setb	_SM1
                                    698 ;	../include/debug.c:168: SM2 = 0;                                                                   //串口0使用模式1
      000B14 C2 9D            [12]  699 	clr	_SM2
                                    700 ;	../include/debug.c:170: RCLK = 0;                                                                  //UART0接收时钟
      000B16 C2 CD            [12]  701 	clr	_RCLK
                                    702 ;	../include/debug.c:171: TCLK = 0;                                                                  //UART0发送时钟
      000B18 C2 CC            [12]  703 	clr	_TCLK
                                    704 ;	../include/debug.c:172: PCON |= SMOD;
      000B1A 43 87 80         [24]  705 	orl	_PCON,#0x80
                                    706 ;	../include/debug.c:173: x = 10 * FREQ_SYS / UART0_BAUD / 16;                                       //如果更改主频，注意x的值不要溢出
      000B1D 75 16 11         [24]  707 	mov	_mInitSTDIO_x_1_16,#0x11
      000B20 75 17 04         [24]  708 	mov	(_mInitSTDIO_x_1_16 + 1),#0x04
      000B23 E4               [12]  709 	clr	a
      000B24 F5 18            [12]  710 	mov	(_mInitSTDIO_x_1_16 + 2),a
      000B26 F5 19            [12]  711 	mov	(_mInitSTDIO_x_1_16 + 3),a
                                    712 ;	../include/debug.c:174: x2 = x % 10;
      000B28 75 1B 0A         [24]  713 	mov	__modulong_PARM_2,#0x0a
      000B2B F5 1C            [12]  714 	mov	(__modulong_PARM_2 + 1),a
      000B2D F5 1D            [12]  715 	mov	(__modulong_PARM_2 + 2),a
      000B2F F5 1E            [12]  716 	mov	(__modulong_PARM_2 + 3),a
      000B31 85 16 82         [24]  717 	mov	dpl,_mInitSTDIO_x_1_16
      000B34 85 17 83         [24]  718 	mov	dph,(_mInitSTDIO_x_1_16 + 1)
      000B37 85 18 F0         [24]  719 	mov	b,(_mInitSTDIO_x_1_16 + 2)
      000B3A E5 19            [12]  720 	mov	a,(_mInitSTDIO_x_1_16 + 3)
      000B3C 12 0B FD         [24]  721 	lcall	__modulong
      000B3F AC 82            [24]  722 	mov	r4,dpl
      000B41 8C 1A            [24]  723 	mov	_mInitSTDIO_x2_1_16,r4
                                    724 ;	../include/debug.c:175: x /= 10;
      000B43 75 1B 0A         [24]  725 	mov	__divulong_PARM_2,#0x0a
      000B46 E4               [12]  726 	clr	a
      000B47 F5 1C            [12]  727 	mov	(__divulong_PARM_2 + 1),a
      000B49 F5 1D            [12]  728 	mov	(__divulong_PARM_2 + 2),a
      000B4B F5 1E            [12]  729 	mov	(__divulong_PARM_2 + 3),a
      000B4D 85 16 82         [24]  730 	mov	dpl,_mInitSTDIO_x_1_16
      000B50 85 17 83         [24]  731 	mov	dph,(_mInitSTDIO_x_1_16 + 1)
      000B53 85 18 F0         [24]  732 	mov	b,(_mInitSTDIO_x_1_16 + 2)
      000B56 E5 19            [12]  733 	mov	a,(_mInitSTDIO_x_1_16 + 3)
      000B58 12 0C 80         [24]  734 	lcall	__divulong
      000B5B 85 82 16         [24]  735 	mov	_mInitSTDIO_x_1_16,dpl
      000B5E 85 83 17         [24]  736 	mov	(_mInitSTDIO_x_1_16 + 1),dph
      000B61 85 F0 18         [24]  737 	mov	(_mInitSTDIO_x_1_16 + 2),b
      000B64 F5 19            [12]  738 	mov	(_mInitSTDIO_x_1_16 + 3),a
                                    739 ;	../include/debug.c:176: if ( x2 >= 5 ) x ++;                                                       //四舍五入
      000B66 74 FB            [12]  740 	mov	a,#0x100 - 0x05
      000B68 25 1A            [12]  741 	add	a,_mInitSTDIO_x2_1_16
      000B6A 50 15            [24]  742 	jnc	00102$
      000B6C 74 01            [12]  743 	mov	a,#0x01
      000B6E 25 16            [12]  744 	add	a,_mInitSTDIO_x_1_16
      000B70 F5 16            [12]  745 	mov	_mInitSTDIO_x_1_16,a
      000B72 E4               [12]  746 	clr	a
      000B73 35 17            [12]  747 	addc	a,(_mInitSTDIO_x_1_16 + 1)
      000B75 F5 17            [12]  748 	mov	(_mInitSTDIO_x_1_16 + 1),a
      000B77 E4               [12]  749 	clr	a
      000B78 35 18            [12]  750 	addc	a,(_mInitSTDIO_x_1_16 + 2)
      000B7A F5 18            [12]  751 	mov	(_mInitSTDIO_x_1_16 + 2),a
      000B7C E4               [12]  752 	clr	a
      000B7D 35 19            [12]  753 	addc	a,(_mInitSTDIO_x_1_16 + 3)
      000B7F F5 19            [12]  754 	mov	(_mInitSTDIO_x_1_16 + 3),a
      000B81                        755 00102$:
                                    756 ;	../include/debug.c:178: TMOD = TMOD & ~ bT1_GATE & ~ bT1_CT & ~ MASK_T1_MOD | bT1_M1;              //0X20，Timer1作为8位自动重载定时器
      000B81 74 0F            [12]  757 	mov	a,#0x0f
      000B83 55 89            [12]  758 	anl	a,_TMOD
      000B85 44 20            [12]  759 	orl	a,#0x20
      000B87 F5 89            [12]  760 	mov	_TMOD,a
                                    761 ;	../include/debug.c:179: T2MOD = T2MOD | bTMR_CLK | bT1_CLK;                                        //Timer1时钟选择
      000B89 43 C9 A0         [24]  762 	orl	_T2MOD,#0xa0
                                    763 ;	../include/debug.c:180: TH1 = 0-x;                                                                 //12MHz晶振,buad/12为实际需设置波特率
      000B8C AF 16            [24]  764 	mov	r7,_mInitSTDIO_x_1_16
      000B8E C3               [12]  765 	clr	c
      000B8F E4               [12]  766 	clr	a
      000B90 9F               [12]  767 	subb	a,r7
      000B91 F5 8D            [12]  768 	mov	_TH1,a
                                    769 ;	../include/debug.c:181: TR1 = 1;                                                                   //启动定时器1
      000B93 D2 8E            [12]  770 	setb	_TR1
                                    771 ;	../include/debug.c:182: TI = 1;
      000B95 D2 99            [12]  772 	setb	_TI
                                    773 ;	../include/debug.c:183: REN = 1;                                                                   //串口0接收使能
      000B97 D2 9C            [12]  774 	setb	_REN
      000B99 22               [24]  775 	ret
                                    776 ;------------------------------------------------------------
                                    ...
                                    782 ;	-----------------------------------------
      000B9A                        783 _CH554UART0RcvByte:
                                    784 ;	../include/debug.c:195: while(RI == 0);                                                            //查询接收，中断方式可不用
      000B9A                        785 00101$:
                                    786 ;	../include/debug.c:196: RI = 0;
      000B9A 10 98 02         [24]  787 	jbc	_RI,00112$
      000B9D 80 FB            [24]  788 	sjmp	00101$
      000B9F                        789 00112$:
                                    790 ;	../include/debug.c:197: return SBUF;
      000B9F 85 99 82         [24]  791 	mov	dpl,_SBUF
      000BA2 22               [24]  792 	ret
                                    793 ;------------------------------------------------------------
                                    ...
                                    801 ;	-----------------------------------------
      000BA3                        802 _CH554UART0SendByte:
      000BA3 85 82 99         [24]  803 	mov	_SBUF,dpl
                                    804 ;	../include/debug.c:210: while(TI ==0);
      000BA6                        805 00101$:
                                    806 ;	../include/debug.c:211: TI = 0;
      000BA6 10 99 02         [24]  807 	jbc	_TI,00112$
      000BA9 80 FB            [24]  808 	sjmp	00101$
      000BAB                        809 00112$:
      000BAB 22               [24]  810 	ret
                                    811 ;------------------------------------------------------------
                                    ...
                                    819 ;	-----------------------------------------
      000BAC                        820 _putchar:
      000BAC AF 82            [24]  821 	mov	r7,dpl
                                    822 ;	../include/debug.c:217: while (!TI) /* assumes UART is initialized */
      000BAE                        823 00101$:
                                    824 ;	../include/debug.c:219: TI = 0;
      000BAE 10 99 02         [24]  825 	jbc	_TI,00112$
      000BB1 80 FB            [24]  826 	sjmp	00101$
      000BB3                        827 00112$:
                                    828 ;	../include/debug.c:220: SBUF = c;
      000BB3 8F 99            [24]  829 	mov	_SBUF,r7
      000BB5 22               [24]  830 	ret
                                    831 ;------------------------------------------------------------
      ...
      000BB6 10 98 02         [24]  842 	jbc	_RI,00112$
      000BB9 80 FB            [24]  843 	sjmp	00101$
      000BBB                        844 00112$:
                                    845 ;	../include/debug.c:226: return SBUF;
      000BBB 85 99 82         [24]  846 	mov	dpl,_SBUF
      000BBE 22               [24]  847 	ret
                                    848 ;------------------------------------------------------------
                                    ...
                                    854 ;	-----------------------------------------
      000BBF                        855 _CH554UART1Alter:
                                    856 ;	../include/debug.c:255: PIN_FUNC |= bUART1_PIN_X;
      000BBF 43 C6 20         [24]  857 	orl	_PIN_FUNC,#0x20
      000BC2 22               [24]  858 	ret
                                    859 ;------------------------------------------------------------
                                    ...
                                    865 ;	-----------------------------------------
      000BC3                        866 _UART1Setup:
                                    867 ;	../include/debug.c:267: U1SM0 = 0;                                                                   //UART1选择8位数据位
      000BC3 C2 C7            [12]  868 	clr	_U1SM0
                                    869 ;	../include/debug.c:268: U1SMOD = 1;                                                                  //快速模式
      000BC5 D2 C5            [12]  870 	setb	_U1SMOD
                                    871 ;	../include/debug.c:269: U1REN = 1;                                                                   //使能接收
      000BC7 D2 C4            [12]  872 	setb	_U1REN
                                    873 ;	../include/debug.c:270: SBAUD1 = 256 - FREQ_SYS/16/UART1_BAUD;
      000BC9 75 C2 98         [24]  874 	mov	_SBAUD1,#0x98
      000BCC 22               [24]  875 	ret
                                    876 ;------------------------------------------------------------
                                    ...
                                    882 ;	-----------------------------------------
      000BCD                        883 _CH554UART1RcvByte:
                                    884 ;	../include/debug.c:282: while(U1RI == 0);                                                           //查询接收，中断方式可不用
      000BCD                        885 00101$:
                                    886 ;	../include/debug.c:283: U1RI = 0;
      000BCD 10 C0 02         [24]  887 	jbc	_U1RI,00112$
      000BD0 80 FB            [24]  888 	sjmp	00101$
      000BD2                        889 00112$:
                                    890 ;	../include/debug.c:284: return SBUF1;
      000BD2 85 C1 82         [24]  891 	mov	dpl,_SBUF1
      000BD5 22               [24]  892 	ret
                                    893 ;------------------------------------------------------------
                                    ...
                                    901 ;	-----------------------------------------
      000BD6                        902 _CH554UART1SendByte:
      000BD6 85 82 C1         [24]  903 	mov	_SBUF1,dpl
                                    904 ;	../include/debug.c:297: while(U1TI ==0);
      000BD9                        905 00101$:
                                    906 ;	../include/debug.c:298: U1TI = 0;
      000BD9 10 C1 02         [24]  907 	jbc	_U1TI,00112$
      000BDC 80 FB            [24]  908 	sjmp	00101$
      000BDE                        909 00112$:
      000BDE 22               [24]  910 	ret
                                    911 ;------------------------------------------------------------
                                    ...
                                    919 ;	-----------------------------------------
      000BDF                        920 _CH554WDTModeSelect:
      000BDF AF 82            [24]  921 	mov	r7,dpl
                                    922 ;	../include/debug.c:312: SAFE_MOD = 0x55;
      000BE1 75 A1 55         [24]  923 	mov	_SAFE_MOD,#0x55
                                    924 ;	../include/debug.c:313: SAFE_MOD = 0xaa;                                                             //进入安全模式
      000BE4 75 A1 AA         [24]  925 	mov	_SAFE_MOD,#0xaa
                                    926 ;	../include/debug.c:314: if(mode){
      000BE7 EF               [12]  927 	mov	a,r7
      000BE8 60 05            [24]  928 	jz	00102$
                                    929 ;	../include/debug.c:315: GLOBAL_CFG |= bWDOG_EN;                                                    //启动看门狗复位
      000BEA 43 B1 01         [24]  930 	orl	_GLOBAL_CFG,#0x01
      000BED 80 03            [24]  931 	sjmp	00103$
      000BEF                        932 00102$:
                                    933 ;	../include/debug.c:317: else GLOBAL_CFG &= ~bWDOG_EN;	                                            //启动看门狗仅仅作为定时器
      000BEF 53 B1 FE         [24]  934 	anl	_GLOBAL_CFG,#0xfe
      000BF2                        935 00103$:
                                    936 ;	../include/debug.c:318: SAFE_MOD = 0x00;                                                             //退出安全模式
      000BF2 75 A1 00         [24]  937 	mov	_SAFE_MOD,#0x00
                                    938 ;	../include/debug.c:319: WDOG_COUNT = 0;                                                              //看门狗赋初值
      000BF5 75 FF 00         [24]  939 	mov	_WDOG_COUNT,#0x00
      000BF8 22               [24]  940 	ret
                                    941 ;------------------------------------------------------------
                                    ...
                                    949 ;	-----------------------------------------
      000BF9                        950 _CH554WDTFeed:
      000BF9 85 82 FF         [24]  951 	mov	_WDOG_COUNT,dpl
                                    952 ;	../include/debug.c:333: WDOG_COUNT = tim;                                                             //看门狗计数器赋值
      000BFC 22               [24]  953 	ret
                                    954 	.area CSEG    (CODE)
                                    955 	.area CONST   (CODE)
                                    956 	.area XINIT   (CODE)
